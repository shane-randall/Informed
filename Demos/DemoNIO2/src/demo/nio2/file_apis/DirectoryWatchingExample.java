...
class DirectoryWatchingExample {
	...
	public static void main(String[] args) throws Exception {
        ...
        // Create a Path object and create the directory.
        File watchDirFile = new File("c:/JavaDev/Temp/watchDir");
        Path watchDirPath = watchDirFile.toPath();
        Files.createDirectory(watchDirPath);

        // Register the newly-created directory with the WatchService.
